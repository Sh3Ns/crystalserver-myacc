...
if ($config['highscores_vocation_box'] && isset($vocation) && $vocation != 'None') {
  foreach ($config['vocations'] as $id => $name) {
    if (strtolower($name) == strtolower($vocation)) {
      $promotion_map = [
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="profession">
                        <option value="" <?= !$vocation || $vocation == 'None' ? 'selected' : '' ?>>(all)</option>
                        <option value="knight" <?= strtolower($vocation ?? '') == 'knight' ? 'selected' : '' ?>>Knights</option>
                        <option value="paladin" <?= strtolower($vocation ?? '') == 'paladin' ? 'selected' : '' ?>>Paladins</option>
                        <option value="sorcerer" <?= strtolower($vocation ?? '') == 'sorcerer' ? 'selected' : '' ?>>Sorcerers</option>
                        <option value="druid" <?= strtolower($vocation ?? '') == 'druid' ? 'selected' : '' ?>>Druids</option>
                        <option value="monk" <?= strtolower($vocation ?? '') == 'monk' ? 'selected' : '' ?>>Monks</option>
                      </select>
                    </td>
                    <td></td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <select name="category">
                        <option value="experience" <?= $list == 'experience' || $list == '' ? 'selected' : '' ?>>Experience Points</option>
                        <option value="axe" <?= $list == 'axe' ? 'selected' : '' ?>>Axe Fighting</option>
                        <option value="club" <?= $list == 'club' ? 'selected' : '' ?>>Club Fighting</option>
                        <option value="distance" <?= $list == 'distance' ? 'selected' : '' ?>>Distance Fighting</option>
                        <option value="fishing" <?= $list == 'fishing' ? 'selected' : '' ?>>Fishing</option>
                        <option value="fist" <?= $list == 'fist' ? 'selected' : '' ?>>Fist Fighting</option>
                        <option value="magic" <?= $list == 'magic' ? 'selected' : '' ?>>Magic Level</option>
                        <option value="shield" <?= $list == 'shield' ? 'selected' : '' ?>>Shielding</option>
                        <option value="sword" <?= $list == 'sword' ? 'selected' : '' ?>>Sword Fighting</option>
                      </select>
                    </td>
                    <td>
                      <div class="BigButton"
                        ...
                        <tbody>
                          ...
                          foreach ($skills as $player) {
                            ...
                            if (++$i <= $limit) {
                              ...
                              echo '<td><a href="' . getPlayerLink($player['name'], false) . '"><span style="color: ' . ($player['online'] > 0 ? 'green' : 'red') . '">' . $player['name'] . '</span></a></td>';
                              ...
                              echo '<td style="text-align:right;">' . $tmp . '</td>';
                              echo '<td><div style="text-align:right;">' . $player['value'] . '</div></td>';
                          ...
                          ?>
                            <tr>
                              <td colspan="2" width="100%" align="right" valign="bottom">
                                <a href="<?= getLink('highscores') . '/' . $list . (isset($vocation) && $vocation != 'None' ? '/' . $vocation : '') . '/' . ($_page - 1) ?>" class="size_xxs">Previous Page</a>
                              </td>
                            </tr>
                          <?php
                          }
                          ...
                          ?>
                            <tr>
                              <td colspan="2" width="100%" align="right" valign="bottom">
                                <a href="<?= getLink('highscores') . '/' . $list . (isset($vocation) && $vocation != 'None' ? '/' . $vocation : '') . '/' . ($_page + 1) ?>" class="size_xxs">Next Page</a>
                              </td>
                            </tr>
                          <?php
                          }
